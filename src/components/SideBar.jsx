...
const SideBar = ({ sideBarFilter, setSideBarFilter }) => {
  return (
    <div className="side-bar">
      <h1>Collections</h1>
      <button onClick={() => setSideBarFilter("")}>
        <svg
        ...
        >
          ...
          <g id="SVGRepo_iconCarrier">
            ...
            ></path>{" "}
            <path
              d="M9.5 16C9.5 14.8954 10.3954 14 11.5 14H12.5C13.6046 14 14.5 14.8954 14.5 16V22H9.5V16Z"
              stroke-linecap="round"
              stroke-linejoin="round"
            ></path>{" "}
          </g>
      ...
      <button onClick={() => setSideBarFilter("liked")}>
        <svg
      ...
      <button onClick={() => setSideBarFilter("watched")}>
        <svg className="sidebar-watch-eye" viewBox="0 0 24 24" stroke-width="">
          <g
            id="SVGRepo_tracerCarrier"
            stroke-linecap="round"
            stroke-linejoin="round"
